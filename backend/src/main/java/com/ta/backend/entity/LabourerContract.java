...
public class LabourerContract {
	...
	public void setEmploymentStartDate(Date emplymentStartDate) {
	...
	public LabourerContract(int contractId, @NotNull Date employmentStartDate, @NotNull Date employmentEndDate,
